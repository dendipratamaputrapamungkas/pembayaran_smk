...
<div class="section mt-2">
    <div class="card mb-3">
        <div class="card-body text-center">
            <img src="{{asset('siswa/assets/img/sample/avatar/avatar4.jpg')}}" alt="Christina Mason"
        ...
        <ul class="listview image-listview flush transparent">
            ...
            <hr />
            <li>
                <a href="javascript:void(0);" onclick="formConfirmationId('#form-logout','Logout Dari Aplikasi?')"
                    class="item">
