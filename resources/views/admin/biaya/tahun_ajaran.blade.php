...
<div class="d-flex justify-content-between">
    ...
    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalBiaya">Tambah Tahun
        Ajaran</button>
</div>
@stop
@section('content')
    ...
    <table class="table text-nowrap mb-0 table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-3"><a
                        href="{{url('dashboard/biaya/'.$detail_biaya->biaya_id.'/'.$detail_biaya->tahun_ajaran_id)}}"
                        class="badge badge-info">Detail Biaya</a></td>
            </tr>
            @empty
