                ...
                <div class="table-responsive">
                    <table class="table-sm text-dark table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sudah_bayar = $riwayat_pembayarans->where('biaya_id',
                            $item->biaya_id)->sum('jumlah_bayar');
    ...
    <table class="table table-hover text-dark" id="dataTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a target="_blank" href="{{route('dashboard.pembayaran.cetak', $riwayat_pembayaran->id)}}"><i
                            class="align-middle" data-feather="printer"></i> <span class="align-middle"></span></a></td>
            </tr>
            @empty
